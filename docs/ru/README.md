...
**Прокси-шлюз для Kiro API (AWS CodeWhisperer)**

[🇬🇧 English](../../README.md) • [🇨🇳 中文](../zh/README.md) • [🇪🇸 Español](../es/README.md) • [🇮🇩 Indonesia](../id/README.md) • [🇧🇷 Português](../pt/README.md) • [🇯🇵 日本語](../ja/README.md) • [🇻🇳 Tiếng Việt](../vi/README.md) • [🇹🇷 Türkçe](../tr/README.md) • [🇰🇷 한국어](../ko/README.md)
...
*Используйте модели Claude через любой инструмент, совместимый с OpenAI или Anthropic*
...
🧠 **Claude Opus 4.5** — Самая мощная модель. Лучше всего подходит для сложных рассуждений, глубокого анализа и исследовательских задач.
...
- Одно из следующего:
  ...
  - [Kiro CLI](https://kiro.dev/cli/) с AWS SSO (Builder ID)
...
### Вариант 1: JSON-файл с учётными данными
...
### Вариант 3: Учётные данные AWS SSO (kiro-cli)

Если вы используете `kiro-cli` с AWS IAM Identity Center (SSO), шлюз автоматически обнаружит и использует аутентификацию AWS SSO OIDC.
...
# Примечание: PROFILE_ARN НЕ нужен для пользователей AWS SSO OIDC (Builder ID)
...
**Примечание:** Пользователям AWS SSO OIDC (Builder ID) НЕ нужен `profileArn`. Шлюз будет работать без него (если указан, он будет проигнорирован).
